...
<main class="content content-dark">
    <div class="container">
            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" id="grade_form" method="post">
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <input type="text" class="form-control" name="grade_code" required placeholder="">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="grade_name" required placeholder="">
                        </div>
                    </div>
            </div>
        </div>
        <div class="block-15 text-center row">
            ...
            <div class="col-sm-4">
                <p>
                    <button class="btn btn-success btn-block" href="<?php echo site_url('admin/grade/create')?>" id="create" disabled="disabled">
                        <span>更新</span>
                    </button>
                </p>
            </div>
