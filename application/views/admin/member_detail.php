                    ...
                    <div class="table-responsive">
                        <table class="table table-outline">
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php 
	                                    if( isset( $course['valid']['classjoin'][0] )  ) {
	                                        $class_join = $course['valid']['classjoin'];
	                                        $date_temp = $class_join[0]['start_date'];

	                                        if( !isset( $class_join[0]['class_name'] ) ) echo '';
	                                        else
	                                        {
	                                            $num_ber = 0;
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    if(  isset( $course['valid']['classjoin'][0] )  ){
                                        $class_join = $course['valid']['classjoin'];
                                        $date_temp =  isset ( $class_join[0]['start_date'] ) ? $class_join[0]['start_date'] : START_DATE_DEFAULT ;
                                    	...
                                    	echo date_format( date_create( START_DATE_DEFAULT ),'Y年m月d日(y年mヶ月)') ;
                                    }
                                    ?>
                                </td>
                                <th>生年月日</th>
                                <td>
                                	<?php
	                                    ...
	                                    if( isset( $meta['birthday'] ) && $meta['birthday'] != INVALID_DATE && $meta['birthday'] !='' )
	                                    {
	                                        ...
	                                        echo date_format( date_create( START_DATE_DEFAULT ),'Y年m月d日') ;
                                    ?>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th>メモ特記事項</th>
                                <td class="text-red" colspan="3"><?php echo isset( $meta['memo_special'] ) ? $meta['memo_special'] :'' ?></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <section>
                    ...
                    <div class="table-responsive">
                        <table class="table table-lg table-blue-green table-outline mb-0">
                            ...
                            if( count( $family ) == 0 )
                            {
                                echo '<tr ><td colspan="7" align= "center"> <strong>データがありません。</strong></td></tr>';
                            }
                            else {
