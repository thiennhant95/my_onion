...
<main class="content content-dark">
    <div class="container">
        ...
        <h1 class="lead-heading h3">
            <span>マスター設定</span>
            <a href="<?php echo site_url('admin/item/export')?>" class="btn btn-default btn-sm pull-right">
                <strong>CSV出力</strong>
            </a>
        </h1>
        ...
        <p class="box-msg">
        <div style="display:none;" id="alert-delete" class='alert alert-success'>品名を削除しました。 </div>
        </p>
        <p class="box-msg">
                    ...
                    foreach ($item_list as $row):
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="row">
                                    <div class="col-xs-6">
                                        <a href="<?php echo site_url('admin/item/edit/'.$row['id'])?>" class="btn btn-outline-blue btn-block btn-sm">編集</a>
                                    </div>
                                    <div class="col-xs-6">
                                        <a href="<?php echo site_url('admin/item/delete/'.$row['id'])?>" class="btn btn-default btn-block btn-sm delete-user-row-with-ajax-button" data-type="品名">削除</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
        ...
        <div class="block-15 text-center row">
            <div class="col-sm-8 col-sm-offset-2">
                <a class="btn btn-info btn-block" href="<?php echo site_url('admin/item/create')?>">
