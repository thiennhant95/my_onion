    ...
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <form class="form-horizontal" action="<?php echo site_url('admin/create-subject/')?>" method="post">
                    <div class="form-group">
                        <label for="" class="col-sm-2 control-label">科目コード</label>
                        <div class="col-sm-3">
                            <input type="text" class="form-control" name="subject_code" placeholder="" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="" class="col-sm-2 control-label">科目名</label>
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="subject_name"  placeholder="" required>
                        </div>
                    </div>
            </div>
        </div>
