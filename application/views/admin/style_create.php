    ...
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <form class="form-horizontal" id="style_form" method="post">
                    <div class="form-group">
                        <label for="" class="col-sm-2 control-label">種目コード</label>
                        <div class="col-sm-3">
                            <input type="text" class="form-control" name="style_code" required placeholder="">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="style_name" required placeholder="">
                        </div>
                    </div>
            </div>
        </div>
        <div class="block-15 text-center row">
            ...
            <div class="col-sm-4">
                <p>
                    <button class="btn btn-success btn-block" href="<?php echo site_url('admin/style/create')?>" id="create" disabled="disabled">
                        <span>更新</span>
                    </button>
                </p>
            </div>
