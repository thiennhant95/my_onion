  ...
  <main class="content content-dark">
    <div class="container">
      ...
      <h1 class="lead-heading h3">
        <span>マスター設定</span>
        <a href="<?php echo site_url('admin/style/export')?>" class="btn btn-default btn-sm pull-right">
          <strong>CSV出力</strong>
        </a>
      </h1>
      ...
      <div class="block-15 text-center row">
        <div class="col-sm-8 col-sm-offset-2">
          <a class="btn btn-info btn-block" href="<?php echo site_url('admin/style/create')?>">
