    ...
    <div class="container">
            ...
            ?>
              <tr>
                ...
                <td>
                  <div class="row">
                    <div class="col-xs-6">
                      <a href="<?php echo site_url('admin/edit-style/'.$row['id'])?>" class="btn btn-outline-blue btn-block btn-sm">編集</a>
                    </div>
                    <div class="col-xs-6">
      ...
      <div class="block-15 text-center row">
        <div class="col-sm-8 col-sm-offset-2">
          <a class="btn btn-info btn-block" href="<?php echo site_url('admin/create-style')?>">
