        ...
        try {
            ...
            if ($data) {
                foreach ($data as $row):
                    ...
                    {
                        case '0': $row['comission_flg']='無し';
                        case '1': $row['comission_flg']='手数料発生';
                        case '2': $row['comission_flg']='免除';
                    }
                    switch ($row['melody_flg'])
                    {
                        case '0': $row['melody_flg']='未';
                        case '1':$row['melody_flg']='済';
                    }
